...
iTj(3,1,2) = 0; iTj(3,2,2) = -1; iTj(3,3,2) = 0; iTj(3,4,2) = 213-(175-60);
iTj(4,1,2) = 0; iTj(4,2,2) = 0; iTj(4,3,2) = 0; iTj(4,4,2) = 1;

iTj(1,1,3) = 0; iTj(1,2,3) = 0; iTj(1,3,3) = -1; iTj(1,4,3) = -(431.50-326.50);
...
iTj(2,1,4) = 0; iTj(2,2,4) = 1; iTj(2,3,4) = 0; iTj(2,4,4) = -145.50;
...
iTj(3,1,6) = 1; iTj(3,2,6) = 0; iTj(3,3,6) = 0; iTj(3,4,6) = -(420-35);
